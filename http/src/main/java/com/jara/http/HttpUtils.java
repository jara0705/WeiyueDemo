package com.jara.http;

import android.content.Context;
import android.support.annotation.NonNull;
import android.text.TextUtils;

import com.jara.http.request.ARequest;
import com.jara.http.result.ProgressResponseBody;
import com.jara.http.result.ResponseResult;
import com.jara.http.util.NetUtils;
            ...
            public void subscribe(@NonNull final ObservableEmitter<ResponseResult> subscriber) throws Exception {
                ...
                if (reqObj instanceof ARequest) {
                    ...
                    switch (aRequest.method()) {
                        case GET:
                            observable = http.get(aRequest.url(), aRequest.params());
                            break;
                        case POST:
                            observable = http.post(aRequest.url(), aRequest.params());
                            break;
                    }
